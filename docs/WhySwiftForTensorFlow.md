...
Below we explain our project goals, discuss the programming language properties that contribute to these goals, provide a short evaluation of specific languages against those goals, and evaluate the pros and cons of Swift. ((TODO: These should all be markdown links to the sections below)).
